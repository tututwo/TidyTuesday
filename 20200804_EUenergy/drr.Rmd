...
marimekko_data %>%
  ...
  replace(is.na(.), 0) %>%
  write_csv(
    "C:/Github/TidyTuesday/20200804_EUenergy/data/tidytuesday_202032_european_energy.csv"
  )
...
marimekko_labels %>%
  ...
  write_csv(
    "C:/Github/TidyTuesday/20200804_EUenergy/data/tidytuesday_202032_european_energy_labels.csv"
  )
